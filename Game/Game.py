...
class Game:
    ...
    # makes sure that both players have a piece
    ...
    # Check default win condition: if one player is out of pieces -> other player wins
    ...
    def message(self):
        print(f"{self.winner} is the victor.")